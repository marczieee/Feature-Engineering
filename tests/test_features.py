...
PyTest Test Suite - Feature Engineering Pipeline
...
@pytest.fixture
def sample_df():
    """Reusable sample DataFrame for all tests"""
    return pd.DataFrame({
        'customer_id':      [1, 2, 3, 4, 5],
        'age':              [22, 35, 45, 55, 70],
        'gender':           ['Male', 'Female', 'Male', 'Other', 'Female'],
        'education':        ['Bachelor', 'Master', 'PhD', 'High School', 'Bachelor'],
        'income':           [30000, 50000, 75000, 100000, 400000],  # 400000 = anomaly
        'purchase_amount':  [100.0, 500.0, 1000.0, 2000.0, 12000.0],  # 12000 = anomaly
...
# ─────────────────────────────────────────────
#  MODULE 1 TESTS: derive_computed_columns
# ─────────────────────────────────────────────
...
class TestDeriveComputedColumns:
    ...
    def test_total_cost_math_correct(self, sample_df):
        result = derive_computed_columns(sample_df)
        expected = round(100.0 + 5.0, 2)
        assert result['total_cost'].iloc[0] == expected
...
# ─────────────────────────────────────────────
#  MODULE 2 TESTS: encode_categorical_features
# ─────────────────────────────────────────────
...
# ─────────────────────────────────────────────
#  MODULE 3 TESTS: bin_numeric_ranges
# ─────────────────────────────────────────────
...
# ─────────────────────────────────────────────
#  MODULE 4 TESTS: time_based_feature_extraction
# ─────────────────────────────────────────────
...
# ─────────────────────────────────────────────
#  MODULE 5 TESTS: flag_anomalies_column
# ─────────────────────────────────────────────
